...
describe('AppChipList', () => {
  ...
  const defaultProps = {
    items: ['Chip 1', 'Chip 2', 'Chip 3', 'Chip 4', 'Chip 5', 'Chip 6', 'Chip 7', 'Chip 8', 'Chip 9', 'Chip 10', 'Chip 11'],
    defaultQuantity: 7,
  ...
  it('should show chip with +3', () => {
    ...
    expect(showMore).toHaveTextContent('+4');
  });
  ...
  it('should show only 10 chips', () => {
    ...
    const initialItems = screen.getByTestId('initial-items');
    expect(initialItems.querySelectorAll('[data-testid="chip"]').length).toBe(10);
  });
